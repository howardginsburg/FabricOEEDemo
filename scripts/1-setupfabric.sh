#!/usr/bin/env bash
# =============================================================================
# 1-setupfabric.sh — End-to-end Fabric OEE demo provisioner
#
...
#   Step 4 — Dashboard JSON generated from oee-dashboard.template.json
...
#
# Usage:
#   bash 1-setupfabric.sh --workspace-name <NAME>
#   bash 1-setupfabric.sh --workspace-name <NAME> --use-device-code
#
# Arguments:
